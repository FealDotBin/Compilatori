...
public class ConcreteLexer implements Lexer {
     ...
     */
    public ConcreteLexer(String filePath) {
     ...
     */
    private Boolean initialize(String filePath){
        try {
    ...
    public Token nextToken() throws Exception{
        ...
        while(true){
            // Legge un carattere da input e restituisce il Token <EOF> quando incontra la fine del file.
            try{
                c = (char) raf.readByte();
    ...
    /**
     * Restituisce la posizione del cursore sul file.
    ...
    /**
     * Porta il cursore alla posizione fornita in input.
     * @param position La posizione in cui deve spostarsi il cursore.
     */
